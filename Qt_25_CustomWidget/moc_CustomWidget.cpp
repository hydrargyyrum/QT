...
QT_MOC_LITERAL(3, 30, 15), // "slotSetProgress"
QT_MOC_LITERAL(4, 46, 1) // "n"

    },
    "CustomWidget\0progressChanged\0\0"
    "slotSetProgress\0n"
};
...
void CustomWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->slotSetProgress((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (CustomWidget::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CustomWidget::progressChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CustomWidget::progressChanged(int _t1)
{
